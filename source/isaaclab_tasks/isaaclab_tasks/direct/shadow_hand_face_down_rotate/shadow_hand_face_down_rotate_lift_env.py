...
from isaaclab_tasks.direct.shadow_hand_face_down_rotate.shadow_hand_face_down_rotate_lift_env_cfg import ShadowHandDirectFaceDownRotateLiftEnvCfg
...
class ShadowHandFaceDownRotateLiftEnv(DirectRLEnv):
    ...
    def _reset_idx(self, env_ids: Sequence[int] | None):
        ...
        # cprint(f"finish_resetting", "cyan")
    ...
    def _reset_target_pose(self, env_ids):
        ...
        # cprint(f"self.goal_pos: {self.goal_pos}", "light_yellow")
