...
from .shadow_hand_face_down_rotate_lift_env_cfg import ShadowHandDirectFaceDownReorientMultiObjectEnvCfg, ShadowHandDirectFaceDownReorientPCTactileMultiObjectEnvCfg
...
gym.register(
    ...
    entry_point="isaaclab_tasks.direct.shadow_hand_face_down_rotate:ShadowHandFaceDownRotateLiftEnv",
...
gym.register(
    ...
    entry_point="isaaclab_tasks.direct.shadow_hand_face_down_rotate:ShadowHandFaceDownRotateLiftDebugEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Isaac-Repose-Cube-Shadow-Direct-Face-Down-Reorient-Multi-Object-v0",
    entry_point="isaaclab_tasks.direct.shadow_hand_face_down_rotate:ShadowHandFaceDownRotateLiftEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": ShadowHandDirectFaceDownReorientMultiObjectEnvCfg,
        "rl_games_cfg_entry_point": f"{agents.__name__}:rl_games_ppo_multiobj_cfg.yaml",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:ShadowHandPPORunnerCfg",
    },
)
...
gym.register(
    ...
    entry_point="isaaclab_tasks.direct.shadow_hand_face_down_rotate:ShadowHandDirectFaceDownReorientPCTactileSingleCamEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Isaac-Repose-Cube-Shadow-Direct-Face-Down-Reorient-PC-Tactile-Multi-Object-v0",
    entry_point="isaaclab_tasks.direct.shadow_hand_face_down_rotate:ShadowHandDirectFaceDownReorientPCTactileSingleCamEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": ShadowHandDirectFaceDownReorientPCTactileMultiObjectEnvCfg,
        "rl_games_cfg_entry_point": f"{agents.__name__}:rl_games_ppo_multiobj_cfg.yaml",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:ShadowHandPPORunnerCfg",
    },
)
...
gym.register(
    ...
    entry_point="isaaclab_tasks.direct.shadow_hand_face_down_rotate:ShadowHandDirectFaceDownReorientPCTactileSingleCamMultiTargetEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": ShadowHandDirectFaceDownReorientPCTactileEnvCfg,
        "rl_games_cfg_entry_point": f"{agents.__name__}:rl_games_ppo_cfg.yaml",
