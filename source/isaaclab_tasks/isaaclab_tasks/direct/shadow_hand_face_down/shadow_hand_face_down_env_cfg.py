...
@configclass
class ShadowHandOpenAIFaceDownEnvCfg(ShadowHandEnvCfg):
    # env
    decimation = 3
    ...
    object_cfg: RigidObjectCfg = RigidObjectCfg(
        ...
        init_state=RigidObjectCfg.InitialStateCfg(pos=(0.0, -0.43, 0.024), rot=(1.0, 0.0, 0.0, 0.0)),
    )
    # goal object
    goal_object_cfg: VisualizationMarkersCfg = VisualizationMarkersCfg(
        prim_path="/Visuals/goal_marker",
...
@configclass
class ShadowHandOpenAIFaceDownHitGroundEnvCfg(ShadowHandOpenAIFaceDownEnvCfg):
...
@configclass
class ShadowHandOpenAIFaceDownMidAirEnvCfg(ShadowHandOpenAIFaceDownEnvCfg):
    ...
    actuated_joint_names = [
        "robot0_WRJ1",
        "robot0_WRJ0",
        "robot0_FFJ3",  # fore finger
        "robot0_FFJ2",
        "robot0_FFJ1",
        "robot0_MFJ3", # middle finger
        "robot0_MFJ2",
        "robot0_MFJ1",
        "robot0_RFJ3", # ring finger
        "robot0_RFJ2",
        "robot0_RFJ1",
        "robot0_LFJ4", # little finger
        "robot0_LFJ3",
        "robot0_LFJ2",
        "robot0_LFJ1",
        "robot0_THJ4", # thumb
    ...
    object_cfg: RigidObjectCfg = RigidObjectCfg(
        ...
        init_state=RigidObjectCfg.InitialStateCfg(pos=(0.0, -0.375, 0.46), rot=(1.0, 0.0, 0.0, 0.0)),
        # init_state=RigidObjectCfg.InitialStateCfg(pos=(0.0, -0.43, 0.0), rot=(1.0, 0.0, 0.0, 0.0)),
    )
    ...
    # the pos of the goal obj is set inside the env

    # other variables
    fall_dist = 0.24  # true falling variable
