...
from isaaclab_tasks.direct.shadow_hand_face_down.shadow_hand_face_down_env_cfg import ShadowHandEnvCfg, ShadowHandOpenAIFaceDownEnvCfg

from termcolor import cprint


class ShadowHandFaceDownEnv(DirectRLEnv):
    cfg: ShadowHandOpenAIFaceDownEnvCfg | ShadowHandEnvCfg

    def __init__(self, cfg: ShadowHandOpenAIFaceDownEnvCfg | ShadowHandEnvCfg, render_mode: str | None = None, **kwargs):
        ...
        self.goal_pos[:, :] = torch.tensor([-0.2, -0.45, 0.15], device=self.device)
