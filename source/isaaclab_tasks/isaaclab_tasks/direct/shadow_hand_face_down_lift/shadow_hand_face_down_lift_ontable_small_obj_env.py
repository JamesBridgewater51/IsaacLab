...
from isaaclab_tasks.direct.shadow_hand_face_down_lift.shadow_hand_face_down_lift_env_small_obj_cfg import ShadowHandDirectDownLiftOntableSmallObjEnvCfg

from termcolor import cprint


class ShadowHandFaceDownLiftOntableSmallObjectEnv(DirectRLEnv):
    cfg: ShadowHandDirectDownLiftOntableSmallObjEnvCfg

    def __init__(self, cfg: ShadowHandDirectDownLiftOntableSmallObjEnvCfg, render_mode: str | None = None, **kwargs):
