...
from isaaclab_tasks.direct.shadow_hand_inhand_push import ShadowInhandPushPCTactileEnvCfg
from isaaclab_tasks.direct.shadow_hand_inhand_push import ShadowInhandPushEnv

from isaaclab_tasks.direct.shadow_hand_inhand_push.shadow_inhand_push_env import compute_rewards, randomize_rotation
...
class ShadowInHandPushPCTactileSingleCamEnv(ShadowInhandPushEnv):
    ...
    def _reset_target_pose(self, env_ids):
        ...
        # back_indices = torch.where(new_pos[:, 1] > self.cfg.box_pos & new_pos[:, 1] < 0)
