...
# add imports
from .inhand_manipulation_hand_init_pc_tactile_env import InHandManipulationHandInitPCTactileEnv, compute_rewards, randomize_rotation


from termcolor import cprint

class InHandManipulationHandInitPCTactileGivenStepEnv(InHandManipulationHandInitPCTactileEnv):
